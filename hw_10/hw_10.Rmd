...
همانند بالا شاخص هایی که 
NA 
کمتری دارند را انتخاب می کنیم. در نهایت می بینیم ایران از نظر آموزش نیز در دسته ی سوم قرار دارد. هم چنین در این بخش مدل خطی ما برای پیشبینی استفاده می کنیم. می بینیم خطای ما حول صفر است.
</p>
```{r, message=FALSE, warning=FALSE, comment=NA}
# education
# 5
