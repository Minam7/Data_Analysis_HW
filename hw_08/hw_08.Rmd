...
<p dir="RTL"> 
بر اساس نمودار های فوق مشاهده می کنیم که آثار ویرجینیا ولف نیز با یکدیگر شباهت داشته و با آثار دیکنز تفاوت دارد. البته در آثار ویرجینیا وولف توزیع 
1-gram 
نزدیک است اما در توزیع 
2-gram 
دو تا از آثار بیشتر شباهت دارند.
</p>
...
<p dir="RTL"> 
بر اساس مقالات خوانده شده، تشخیص نویسنده ی کتاب بر اساس این روش حدود ۷۰ درصد است.
</p>