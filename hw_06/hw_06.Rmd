...
<br>
استقلال:
بر اساس نتیجه ی کوریلیشن و هم چنین نمودار باقیمانده ها، متوجه می شویم که این داده ها از باقیمانده ها مستقل هستند.
<br>
نرمال بودن:
با توجه به نمودار
Q-Q
...
```
<p dir="RTL"> 
همانطور که مشاهده می کنیم، خطای ما افزایش یافته است و تنها ۷۵٪ داده ها را درست پیش بینی می کنیم.
</p>
